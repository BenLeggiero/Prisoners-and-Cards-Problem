...
external class JQuery {
    ...
    fun css(propertyName: String, newValue: String?): JQuery
    fun css(propertyName: String, newValue: (index: Int, value: String?) -> String?): JQuery
    ...
    fun height(): Number
    fun height(newValue: String): JQuery
    fun height(newValue: Number): JQuery
    fun width(): Number
    fun width(newValue: String): JQuery
    fun width(newValue: Number): JQuery
